/**
 * src/app/api/contact-image/route.ts
 *
 * Serves the Contact HQ Office visual cleanly with zero DB pool blocking.
...
const KEY = "CONTACT_HQ_IMAGE";
const PUBLIC_FILE = "contact-hq.png";
const ARTIFACT_PREFIX = "contact_hq_office";
