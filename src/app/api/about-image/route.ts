/**
 * src/app/api/about-image/route.ts
 *
 * Serves the About page hero visual cleanly with zero DB pool blocking.
...
const KEY = "ABOUT_HERO_IMAGE";
const PUBLIC_FILE = "about-hero.png";
const ARTIFACT_PREFIX = "about_hero_visual";
  ...
  try {
    ...
    if (dbRecord?.value && dbRecord.value.startsWith("data:image/")) {
      ...
      if (base64Data) {
        ...
        // Save to public for future zero-DB calls
        try {
